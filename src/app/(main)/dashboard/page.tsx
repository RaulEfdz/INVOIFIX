            ...
            <CardContent className="flex flex-col md:flex-row items-center gap-6">
              ...
              <div>
                <p className="mb-4 font-light text-muted-foreground">
                  InvoiFix le ayuda a optimizar sus procesos de facturación y
                  soporte. Cree y rastree facturas, administre los tickets de
                  los clientes y manténgase organizado con nuestra plataforma
                  intuitiva.
                </p>
                <p className="mb-4 font-light text-muted-foreground">
                  Explore la barra lateral para navegar por las diferentes
                  secciones, como Facturas y Tickets. Utilice las acciones
                  rápidas anteriores para comenzar de inmediato.
                </p>
